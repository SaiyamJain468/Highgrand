...
export default function TopMarquee({ announcement }: { announcement?: string }) {
  const items = announcement 
    ? [announcement, "SHIPPING NATIONWIDE - DELHI TO KERALA", "ESTABLISHED 2013 - 12 YEARS OF CRAFT"] 
    : [
